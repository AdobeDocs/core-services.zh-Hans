...
* 当用户发起电子邮件以与其他用户共享ecatalog时，系统会将第二个AS2查看器项目符号中的附注内容复制到Adobe的服务器，以将其提供给收件人。 当收件人启动查看器会话时，将从服务器检索附注内容并将该内容复制到 Cookie。此功能很少使用，因此不会过期，也不会删除旧内容。当前，它会无限期地保留在服务器上。
