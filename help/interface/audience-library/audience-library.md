---
description: 管理访客数据转换为受众细分。
seo-description: 管理访客数据转换为受众细分。
seo-title: 受众
solution: Experience Cloud
title: 受众
uuid: 92ff3a8-1375-4e32-905b-74design48144d3
...
* 在 [!DNL Experience Cloud]
* 从 [!DNL Analytics] 发布到 [!DNL Experience Cloud]
* 从 [!DNL Audience Manager]

**实时与历史受众比较**

所有受众，无论其来源如何，都可供实时定位用例访问。但是，无法访问从Analytics到Audience Manager的受众以实时定位。系统通过以下两种方式评估受众：

* 源于 Analytics 的历史受众每 12 个小时接受一次评估。历史受众始终包含回访访客。
* 实时受众源于Experience Cloud受众并实时评估。
...
| 解决方案 | 描述 |
|--- |--- |
| Experience Cloud 受众 | 使用 [受众库](../audience-library/audience-library.md) 界面本机创建、管理和分享受众。您可以：<ul><li>使用原始 analytics 属性的实时受众</li><li>加入实时和历史数据，合并受众以创建组合受众</li><li>请参阅预计受众大小的图示</li></ul><br>有关要创建的受众类型的建议，请参阅：[Experience Cloud 受众](https://helpx.adobe.com/marketing-cloud-core/kb/People/Audience-Creation-Options.html)。 |
...
| Mobile Services | 使用 [设备类型中的朝阳可视化分析移动流量](https://marketing.adobe.com/resources/help/en_US/mobile/?f=reports_devices)。 |
| Target | [ID 服务](https://marketing.adobe.com/resources/help/en_US/mcvid/)将访客 ID 与数据合并为一份可操作的资料，以便在各个解决方案之间使用。Adobe Analytics中区段创建过程中 [的“发布到Experience Cloud”](../audience-library/audience-library.md) 复选框允许区段在Adobe Target的自定义受众库内可用。在 Analytics 或 Audience Manager 中创建的区段可用于 Target 中的活动。例如，你可以根据 Analytics 转化量度和 Analytics 中创建的受众区段，来创建营销活动。 |
...
>[!IMPORTANT]
>
>当访客符合从Analytics共享的受众资格后，在Target、Media Optimizer和Campaign中可操作的时间有24-48小时延迟。
...
| 需要帮助的方面 | 资源 |
|--- |--- |
| 找不到受众？ | 确保已对您进行配置。请参阅[入门-支持核心服务的解决方案](../core-services/core-services.md)。<br>单击[此处](https://www.adobe.com/go/audiences)请求 Profiles &amp; Audiences（集成配置表单）的访问权限。 |
...
| 标题和描述 | 列标题，用于识别和描述受众。 |
| 作者 | 创建受众区段的人。 |
| 来源 | 识别受众的创建位置。<ul><li>**分析：** 在报告和分析或临时分析中创建的区段，然后 [发布到Experience Cloud](../audience-library/audience-library.md)。</li><li>**Experience Cloud：** 新受众[在 Experience Cloud 受众中创建](../audience-library/audience-library.md)。</li><li>**Audience Manager：** 由 Audience Manager 创建的受众自动显示在 Experience Cloud 受众中。</li></ul> |
| 当前大小 | 当前受众大小 |
| 活动 | 区段的活动状态。 |
