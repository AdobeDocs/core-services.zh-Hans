...
本页介绍了开始集成CX企业应用程序的几种方法。 有关详细信息，请浏览Experience League上的[集成视频教程](https://experienceleague.adobe.com/docs/experience-platform/tags/home.html)库。
...
* 让您成为管理员。
* [实施CX Enterprise ID服务](https://experienceleague.adobe.com/docs/id-service/using/home.html)。
...
* [CX Enterprise ID服务](https://experienceleague.adobe.com/docs/id-service/using/home.html)
...
请参阅[CX Enterprise ID服务](https://experienceleague.adobe.com/docs/id-service/using/home.html)
...
帮助： [将Adobe Target与CX Enterprise集成](/help/interface/services/audiences/overview.md)

将Adobe Target与Adobe Analytics及其他CX Enterprise应用程序集成，以便能够在这两个应用程序中使用相同的数据、受众、属性和量度。
...
* AEM
* Creative Cloud
* [CX企业版](https://experienceleague.adobe.com/docs/)
