...
| [查看用户详细信息（管理工具）](admin-tool-experience-cloud.md) | 查看所有Experience Cloud用户和策略的可排序和可过滤列表，详细信息位于[!UICONTROL Admin Tool]中。 |
...
* [Advertising Search、Social和Commerce](https://experienceleague.adobe.com/zh-hans/docs/advertising/search-social-commerce/target/user-administration)
