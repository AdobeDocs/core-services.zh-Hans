...
要查找Experience Cloud首选项，请单击标题中的&#x200B;**[!UICONTROL Profile]** ![首选项](../assets/preferences-icon-sm.png)，然后单击&#x200B;**[!UICONTROL Preferences]**。
...
* 您必须拥有[!DNL Slack]帐户。 您的[!DNL Slack]管理员允许与[!DNL Slack]集成Experience Cloud。
...
1. 找到[!DNL Slack]，然后单击&#x200B;**[!UICONTROL Add to Slack]**。
...
1. 在&#x200B;**[!UICONTROL Notifications]**&#x200B;下，为所需的产品和类别启用[!DNL Slack]通知。
...
1. 要请求[!DNL Slack]工作区经理的申请审批，请单击&#x200B;**[!UICONTROL Submit]**。

1. 申请请求获得批准后，您将在[!DNL Slack]中收到通知。

1. 收到[!DNL Slack]批准后，请返回Experience Cloud **[!UICONTROL Notifications]**&#x200B;并按照步骤[订阅Slack](#slack-notifications)（如上所述）。
...
* 用于管理Experience Cloud上的通知首选项的链接。

## 在Experience Cloud中查看[!UICONTROL notifications]和公告

在[!DNL Experience Cloud]标题中，您可以查看[订阅了](#notifications)的通知，以及查看公告。

1. 单击标题中的铃铛图标。 ![通知和公告](../assets/bell-icon.png)

1. 单击 **[!UICONTROL Notifications]** 或 **[!UICONTROL Announcements]**。
