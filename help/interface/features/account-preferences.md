...
| [!UICONTROL 产品使用情况数据] | 在使用Experience Cloud应用程序时，您可以控制与Adobe共享的产品使用数据。 这些是有关您如何使用我们产品的数据，而不是您组织的内容或数据本身。 Adobe将使用此信息来帮助改进我们的产品、为您提供增强的产品内支持，以及个性化您的体验和我们之间的通信。 <p>若要了解详细信息，请参阅[产品使用情况数据](#product-usage-data)（在此页面上）。 |
...
如果未安装[!DNL Slack]，则当您单击“_[!UICONTROL 添加到Slack]_”后Slack打开时，会显示一条&#x200B;**[!UICONTROL 安装请求]**&#x200B;消息。 例如：
...
1. 收到[!DNL Slack]批准后，请返回Experience Cloud **[!UICONTROL 通知]**，然后按照步骤[订阅Slack](#slack-notifications)（如上所述）。
...
## 在Experience Cloud中查看[!UICONTROL 通知]和公告 {#view-notifications}
