...
|------------------|-------------------------|------------------|---------------------------|
| [Adobe GenStudio for Performance Marketing](#gspm) | GenStudio for Performance Marketing是一款genAI应用程序。 它有助于营销和创意团队创建个性化的品牌内内容。 | 不适用 | 是 |
| [Adobe Experience Manager Sites](#aem) | GenAI用于[生成变体](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor?lang=en)中以根据输入创建内容变体。 | 不适用 | 是 |
| [Sites Optimizer](#aem) | GenAI可帮助您分析和改进Web体验的性能和有效性。 | 不适用 | 否 |
| [Adobe Experience Manager Assets](#aem) | GenAI用于[Content Hub](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-cloud-service/content/assets/content-hub/product-overview?lang=en)和AI生成的[智能标记](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-cloud-service/content/assets/manage/smart-tags?lang=en#ai-smart-tags)。 | 不适用 | 是 |
| [Adobe Journey Optimizer](#journey-optimizer) | 不适用 | 可用于产品知识和运营分析。 | 否 |
...
| [[!DNL Adobe Journey Optimizer] B2B edition](#ajo-b2b) | 不适用 | 可提供产品知识方面的帮助。 | 否 |
| [[!DNL Campaign] 托管云服务](#campaign-cs) | 不适用 | 可用于Content Accelerator ，根据跨渠道（如电子邮件、短信和推送）的营销目标自动生成个性化、引人入胜且有效的内容 | 是 |
...
| [[!DNL Real-Time CDP]](#rtcdp) | 不适用 | 可从Experience League获取产品知识。 它还提供运营见解（测试版）。 | 否 |
...
| [[!DNL Workfront]](#workfront) | GenAI与[应用程序内](https://experienceleague.adobe.com/zh-hans/docs/workfront/using/basics/ai-assistant/ai-assistant-overview?lang=en)信息和建议一起使用。 | 不适用 | 是 |
