...
以下是使用生成式AI功能和AI Assistant的[!DNL Experience Cloud]个应用程序的汇总。 指示了生成式AI功能与[Adobe Firefly](https://business.adobe.com/products/firefly-business/firefly-ai-approach.html)的兼容性。
...
| **[!DNL Customer Journey Analytics]** | GenAI用于：<ul><li> [智能字幕](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/visualizations/intelligent-captions?lang=en)：有关最常用工作区可视化的见解。</li><li>[内容分析](https://experienceleague.adobe.com/en/docs/analytics-platform/using/content-analytics/report/report?lang=en#template)：自动分配资源元数据。</li></ul> AI Assistant用于：<ul><li>[产品知识](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2c-overview/ai-assistant?lang=en) </li><li>[产品支持代理](agentic-ai.md) </li><li>[Data Insights代理](agentic-ai.md)</li></ul> | 否 |
...
以下部分将更详细地介绍如何在特定应用程序中使用genAI或AI Assistant。 还提供了指向了解更多信息的链接。
...
AEM Sites Optimizer使用创新型人工智能来分析和改进Web体验的性能和有效性。 这些见解将分组为关键机会领域：参与、流量获取、安全状态以及站点运行状况。 每个类别都重点介绍增强站点的特定方法，包括增加访问者交互、提高可发现性、增强安全性或维护站点稳定性。
...
在AEM Assets中，您可以在&#x200B;**内容中心**&#x200B;和&#x200B;**AI生成的智能标记**&#x200B;中使用生成式AI。
...
在[!DNL Journey Optimizer] (AJO)中，您可以使用[AI Assistant](https://experienceleague.adobe.com/zh-hans/docs/journey-optimizer/using/get-started/ai-assistant)获取&#x200B;_产品知识_&#x200B;和&#x200B;_操作见解_ (Beta)。
...
经验丰富的用户可获得高级用例或学习策略以快速执行任务。 您可以快速理解概念、排除问题或搜索信息。
...
您可以使用&#x200B;_中的_&#x200B;智能字幕[!DNL Customer Journey Analytics]获取最常用工作区可视化的自然语言见解。 智能字幕非常适合需要叙述和上下文来与其他用户分享的分析师。 企业用户可以利用它快速发现高级别的收获。
