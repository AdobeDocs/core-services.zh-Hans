...
以下是使用创作AI功能和AI助手的[!DNL Experience Cloud]应用程序的汇总。 指明了与[Adobe Firefly](https://business.adobe.com/cn/products/firefly-business/firefly-ai-approach.html)的兼容性，以实现创作AI功能。
