...
| **Adobe Journey Optimizer B2B edition** | 不适用 | 可提供产品知识方面的帮助。 [了解详情](https://experienceleague.adobe.com/en/docs/journey-optimizer-b2b/user/ai-assistant/ai-assistant-overview) | 否 |
| **[!DNL Campaign]托管云服务** | 不适用 | 可用于Content Accelerator ，根据跨渠道（如电子邮件、短信和推送）的营销目标自动生成个性化、引人入胜且有效的内容。 [了解详情](https://experienceleague.adobe.com/en/docs/campaign-web/v8/content/ai-assistant/generative-gs) | 是 |
...
| **[!DNL Workfront]** | GenAI与[应用程序内](https://experienceleague.adobe.com/en/docs/workfront/using/basics/ai-assistant/ai-assistant-overview?lang=en)信息和建议一起使用。 了解详情 | 不适用 | 是 |
