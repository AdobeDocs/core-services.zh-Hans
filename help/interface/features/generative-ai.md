...
* **运营分析：**&#x200B;例如，Experience Platform中的[运营分析](https://experienceleague.adobe.com/zh-hans/docs/experience-platform/ai-assistant/questions#objects-questions)是指有关您的元数据对象（属性、受众、数据流、数据集等）的生成的响应。 使用[!UICONTROL AI Assistant]，您可以在几秒钟内完成可能需要数小时或数天的任务。
...
以下是使用生成式AI功能和AI Assistant的[!DNL Experience Cloud]个应用程序的汇总。 指示了生成式AI功能与[Adobe Firefly](https://business.adobe.com/cn/products/firefly-business/firefly-ai-approach.html)的兼容性。
