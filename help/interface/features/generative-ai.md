...
**注意：** [!DNL Experience Platform Agents]在Experience Cloud中的[代理AI](agentic-ai.md)中进行了描述。
...
| **Adobe Experience Platform** | | 可用于产品知识和运营分析。 [了解详情](https://experienceleague.adobe.com/zh-hans/docs/experience-platform/ai-assistant/landing) | 否 |
