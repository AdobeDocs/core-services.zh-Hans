...
|------------------|-------------------------|------------------|---------------------------|
| [Adobe GenStudio for Performance Marketing](#gspm) | genAI应用程序，可帮助营销和创意团队创建个性化的品牌内内容。 | 不适用 | 是 |
| [Adobe Experience Manager Sites](#aem) | 在[生成变体](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor?lang=en)中用于根据输入创建内容变体。 | 不适用 | 是 |
| [Sites Optimizer](#aem) | 帮助您分析和改进Web体验的性能和有效性。 | 不适用 | 否 |
| [Adobe Experience Manager Assets](#aem) | 在[Content Hub](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-cloud-service/content/assets/content-hub/product-overview?lang=en)和AI生成的[智能标记](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-cloud-service/content/assets/manage/smart-tags?lang=en#ai-smart-tags)中使用。 | 不适用 | 是 |
