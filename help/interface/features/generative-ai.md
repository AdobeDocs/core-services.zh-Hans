...
* [产品支持代理](https://experienceleague.adobe.com/en/docs/experience-platform/ai-assistant/new-features/customer-support)以创建客户支持工单，并包含您与AI助手交互时的上下文和会话详细信息。
* [Data Insights Agent](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2c-overview/data-analysis-ai)以获取有关您数据的问题解答。 它使用数据视图中的组件并使用实际数据在Analysis Workspace中构建相关可视化图表。
