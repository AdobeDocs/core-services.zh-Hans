...
CX Enterprise中的![[!UICONTROL 统一搜索]](../assets/unified-search-results.png)
...
例如，_如何创建架构_&#x200B;将从&#x200B;_[!UICONTROL 学习]_&#x200B;下的Experience League生成结果：

CX Enterprise帮助中的![[!UICONTROL 统一搜索]](../assets/unified-search-learning.png)
...
* 匹配百分比
* 精确匹配
* _[!UICONTROL 排名最前结果]_&#x200B;部分显示排名前30的结果。
