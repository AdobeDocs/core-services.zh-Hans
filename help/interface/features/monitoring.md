...
管理员使用此功能板根据权利跟踪许可证使用情况。 要访问仪表板，请参阅[!DNL Experience Platform]文档中的[许可证使用情况仪表板](https://experienceleague.adobe.com/en/docs/experience-platform/dashboards/guides/license-usage)。
