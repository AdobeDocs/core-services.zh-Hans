...
| **品牌治理代理*** | <ul><li>[品牌治理](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/ai-in-aem/agents/governance/overview)：通过自动的品牌策略检查、权限和智能功能保护品牌完整性和合规性，从而通过实时治理支持DRM。</li> | <ul><li>Adobe Experience Manager Assets</li></ul> |
