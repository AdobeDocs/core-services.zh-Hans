...
| 代理名称 | 可用性 | 功能 | 支持的应用程序 |
|---|----------|----------|----------|
| [内容优化代理](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-cloud-service/content/ai-in-aem/business-agents/content-optimization/using) | 2025年11月21日 | 使用自然语言提示简化从源资源创建可视内容变体的过程。 | <ul><li>Adobe Experience Manager （使用[Dynamic Media和OpenAPI](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-cloud-service/content/assets/dynamicmedia/dynamic-media-open-apis/dynamic-media-open-apis-overview)）</li></ul> |
| [开发代理](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-cloud-service/content/ai-in-aem/business-agents/development/overview) | 2025年11月21日 | 通过分析根本原因并提出修复建议，帮助AEM CS开发人员和技术管理员解决Cloud Manager管道中的构建步骤失败问题。 | <ul><li>AEM Cloud Service和Adobe Managed Services中的AI助手</li></ul> |
| [发现代理](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-cloud-service/content/ai-in-aem/business-agents/discovery/using) | 2025年11月21日 | 利用简化的自然语言提示，可加快创作速度并加快发现速度，从而即时跨图像、视频、基于文本的文档、内容片段和表单查找和呈现Experience Manager内容。 | <ul><li>Adobe Experience Manager云服务</li></ul> |
| [体验生产代理](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-cloud-service/content/ai-in-aem/business-agents/production/overview) | 2025年11月21日 | 在CMS中自动执行高工作量任务。 该代理将手动冗长的流程转换为快速的AI辅助工作流，让每个体验都保持最新和一致，帮助您的企业实现目标。 | <ul><li>Adobe Experience Manager Cloud Services和Edge Delivery Services</li></ul> |
