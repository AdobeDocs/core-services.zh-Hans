...
| [Adobe Marketing Agent for Microsoft 365 Copilot](https://experienceleague.adobe.com/en/docs/experience-cloud-ai/experience-cloud-ai/agents/ama-ms) | 将Experience Platform直接连接到Microsoft 365 Copilot。 您可以在Microsoft 365应用程序（如Teams、Word、Powerpoint和Excel）中询问自然语言问题，以便立即从Experience Platform中检索营销洞察，而不会中断您的工作流程。 | <ul><li> Adobe Agent Orchestrator，可支持Audience Agent、Journey Agent、Customer Journey Analytics数据分析、Experience Platform运营分析</li></ul> |
