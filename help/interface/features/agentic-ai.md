...
使用AI代理执行&#x200B;_代理作业_&#x200B;将使用AI积分。 了解有关[代理作业和AI信用消耗](https://experienceleague.adobe.com/en/docs/core-services/interface/features/ai-credit-consumption)中的代理作业和AI信用消耗的详细信息。
...
| [品牌治理代理](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/ai-in-aem/agents/governance/overview)* | <ul><li>通过自动化的品牌策略检查、权限和智能功能来确保品牌完整性和合规性，从而通过实时治理支持DRM。</li> | <ul><li>Adobe Experience Manager Assets</li><li>Adobe Experience Manager Sites（品牌策略）</li></ul> |
