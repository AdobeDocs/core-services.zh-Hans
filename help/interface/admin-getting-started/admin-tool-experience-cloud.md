---
description: 了解 Experience Cloud 管理工具，以查看所有 Experience Cloud 用户和策略的可排序和可过滤列表。
keywords: core services
seo-description: 了解 Experience Cloud 管理工具，以查看所有 Experience Cloud 用户和策略的可排序和可过滤列表。
...
| 元素 | 描述 |
|---|---|
| [!UICONTROL 产品配置文件] | 产品配置文件的名称。此列可以按 A->Z、Z->A 进行排序。单击产品配置文件的名称可查看有关策略的更多详细信息。 |
...
* 按升序或降序值对列排序。这适用于“[!UICONTROL 产品配置文件]”、“[!UICONTROL 产品]”、“[!UICONTROL 实例]”、“[!UICONTROL 用户数量]”和“[!UICONTROL 开发人员数量]”列。
