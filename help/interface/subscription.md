---
description: 了解解决方案数据源和配置订阅。通过进行订阅，客户属性数据将能够在 Experience Cloud 与应用程序（Analytics 和 Target）之间传送。
keywords: 客户属性;核心服务
...
了解应用程序数据源和配置订阅。通过进行订阅，客户属性数据将能够在 Experience Cloud 与应用程序（[!DNL Analytics] 和 [!DNL Target]）之间传送。
