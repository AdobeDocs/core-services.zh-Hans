...
* [CX Enterprise Identity Service](https://experienceleague.adobe.com/en/docs/id-service/using/intro/overview)： ECID服务始终设置第一方Cookie，无论您的收集域与网站域是否匹配。 它使用JavaScript将Cookie放置在您网站的域中。
