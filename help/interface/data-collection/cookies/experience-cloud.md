...
Adobe Experience Cloud使用Cookie来存储跨Experience Cloud应用程序使用的访客ID。 这些Cookie特别适用于访问以下位置的Adobe Experience Cloud应用程序： [experience.adobe.com](https://experience.adobe.com).
