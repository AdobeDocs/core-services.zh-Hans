...
* 对于Adobe Analytics AppMeasurement实施，请更新[`trackingServer`](https://experienceleague.adobe.com/zh-hans/docs/analytics/implementation/vars/config-vars/trackingserver)配置变量。 如果您已有实施，请参阅[访客迁移](https://experienceleague.adobe.com/zh-hans/docs/analytics/technotes/visitor-migration)，以了解有关如何防止将现有访客计为新访客的其他步骤。
* 对于Web SDK实施，更新[`edgeDomain`](https://experienceleague.adobe.com/zh-hans/docs/experience-platform/web-sdk/commands/configure/edgedomain)命令中的[`configure`](https://experienceleague.adobe.com/zh-hans/docs/experience-platform/web-sdk/commands/configure/overview)属性。
...
不会。Adobe为所有Adobe Experience Cloud客户提供此服务，不会产生额外费用。
