...
DNS 预获取会自动处理页面上的静态嵌入式链接。这也意味着自动DNS预获取不能与其他[!UICONTROL Experience Cloud]应用程序和服务结合使用，因为：
...
* **Experience Cloud ID服务：** `<link rel="dns-prefetch" href="//fast.examplepartnerid.demdex.net">`
