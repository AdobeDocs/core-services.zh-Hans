...
| 功能 | 描述 |
|--- |--- |
| 批量报表包映射 | 在“管理”>“报表包映射”中，现在可以选择多个报表包，然后将它们映射到某个组织。（以前，必须单独映射每个报表包。）<br>[映射报表包](core-services.md) 对于单个组织，有助于在Experience Cloud中启用跨应用程序功能和服务。 |
