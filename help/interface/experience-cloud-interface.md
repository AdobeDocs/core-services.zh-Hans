---
description: 了解如何登录以及CX Enterprise中的中央界面组件。 了解全局搜索、您的帐户偏好设置以及如何浏览界面并获取帮助。
...
CX Enterprise支持每个用户的首选语言，如您的Adobe用户帐户偏好设置中所设置。 当前支持的语言为：
...
虽然所有应用程序团队都致力于提供全球语言支持，但并非所有应用程序都具有上述所有语言版本。 如果CX Enterprise应用程序不支持您的主要语言，您还可以将辅助语言设置为默认语言（如果适用）。 此操作可在[CX Enterprise用户首选项](https://experience.adobe.com/preferences)中完成。
...
1. 单击 **[!UICONTROL Sign in with an Adobe ID]**。
1. 验证您是否处于正确的组织中。

   ![验证您的组织](assets/organizations-menu.png)

   要验证您是否已登录到正确的组织，请单击&#x200B;**[!UICONTROL Profile]**&#x200B;查看组织名称。 如果您有权访问多个组织，还可以使用&#x200B;**[!UICONTROL Organization]**&#x200B;选择器查看和切换到另一个组织。
...
单击应用程序选择器![菜单](assets/menu-icon.png)以访问您拥有的CX Enterprise服务。

![访问CX Enterprise应用程序](assets/platform-core-services.png)

## CX Enterprise中的搜索和支持

CX Enterprise搜索允许您搜索有关[Experience League](https://experienceleague.adobe.com/zh-hans?lang=zh-hans#home)的帮助（文档、教程和课程）。

在CX Enterprise中![搜索和支持](assets/search-menu.png)

[!UICONTROL Help]菜单还允许您访问：

* **[!UICONTROL Support]：**&#x200B;创建支持工单或使用Twitter联系[!UICONTROL Support]。
* **[!UICONTROL Feedback]：**&#x200B;使用反馈联系Adobe，告诉我们您的想法。
...
CX Enterprise首选项包括通知、订阅和警报。

* 单击帐户菜单![首选项](assets/preferences-icon-sm.png)中的&#x200B;**[!UICONTROL Preferences]**&#x200B;以管理首选项。

![管理CX Enterprise](assets/preferences-page.png)

在[!UICONTROL CX Enterprise preferences]上，您可以配置以下功能：

| 功能 | 描述 |
| --- | --- |
| 默认组织 | 选择您希望在启动CX Enterprise时看到的组织。 |
...
| [!UICONTROL Alerts] | 选择您希望在浏览器中显示警报的通知。 警报会在窗口右上角出现几秒钟。 |
...
单击&#x200B;**[!UICONTROL Notifications]**&#x200B;可查看对您很重要的通知，以及来自Adobe的公告。

![通知和公告](assets/notifications-menu-small.png)

您可以在[CX Enterprise首选项](#preferences)中配置通知。
