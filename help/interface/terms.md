...
keywords: 资源共享;受众服务;Creative Cloud;核心服务
...
| 数据使用情况强制实施 | 无特殊用途。 | 由系统（应用程序、应用程序、服务、SDK、API等）为使用数据使用情况元数据而制定和定义的政策、系统设计、惯例和规程，以使数据使用符合Adobe公司隐私政策、合同注意事项和一般隐私原则。 |
...
| 链接 | 无特殊用途。关联是指超链接导航，以及关联各种项目，如字体、属性、图层等等。 | 在Experience Cloud中，关联通常是指将不同的应用程序帐户关联到界面。<br>请参阅[组织和帐户关联](organizations.md)。<br>关联/链接还指发送给其他用户的 Analytics 报表所对应的标准 URL。 |
...
| 解决方案 | 无特殊用途。 | 在Experience Cloud中，应用程序称为产品，如Adobe Analytics、Adobe Social、Adobe Target等。 |
