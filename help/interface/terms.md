...
| 上下文 | 通常指与某个选择或正在执行的任务相关的可用菜单或信息。 | 上下文描述访客当前与某个数字财产交互的详细信息。例如，上下文包括他们的鼠标位置、表单字段的状态、其购物车的金额或他们所使用的设备。<br>[动态标签管理](https://docs.adobe.com/content/help/zh-Hans/dtm/using/dtm-home.translate.html) ，提供当今市场上最强大的上下文检测和服务激活功能，并提供用户档案和受众服务的上下文组件。 |
