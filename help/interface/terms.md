...
| 合作和共享 | 您可以将 Adobe Experience Manager (AEM) 资产内的资产与 Experience Cloud 和 Adobe Creative Cloud 共享。 | 在 Experience Cloud 中，您可以使用[信息源](feed.md)创建帖子和[共享资产](experience-cloud-assets/experience-cloud-assets.md)。 |
| 上下文 | 通常是指与正在执行的选择或任务相关的可用菜单或信息。 | 上下文描述访客当前与某个数字财产交互的详细信息。例如，上下文包括他们的鼠标位置、表单字段的状态、其购物车的金额或他们所使用的设备。<br>Dynamic tag management](https://marketing.adobe.com/resources/help/zh_CN/dtm/?f=dtm_home) 提供当今市场上最强大的上下文检测和服务激活功能，并提供配置文件和受众服务的上下文组件。 |
