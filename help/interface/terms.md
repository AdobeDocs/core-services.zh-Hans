...
| 属性 |  | 如果人们符合某个细分的条件，他们有哪些共 [同点](https://docs.adobe.com/content/help/en/analytics/components/segmentation/seg-home.html)。 (与Audience manager中的特 [征](https://docs.adobe.com/content/help/en/audience-manager/user-guide/aam-glossary.html#s-t) 相似。) |
