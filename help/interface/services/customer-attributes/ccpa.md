...
description: 了解对《加州消费者隐私法案》的[!DNL Customer Attributes]支持
...
作为您的服务提供商，Adobe CX Enterprise将为您的企业提供支持，使其履行CCPA规定的适用于CX Enterprise产品和服务使用的义务。 上述支持包括管理有关访问和删除个人信息的请求。
