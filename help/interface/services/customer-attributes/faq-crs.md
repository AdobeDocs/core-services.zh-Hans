...
| 是否需要迁移到 Experience Cloud ID 服务？ | 迁移取决于您使用的应用程序。 <ul><li>Adobe Analytics：强烈推荐 </li><li>Adobe Target：必需。 </li></ul><br>使用Experience CloudID服务可启用最新的Experience Cloud功能，包括实时受众、Adobe Target现代化、Analytics集成和视频检测信号跟踪。 |
