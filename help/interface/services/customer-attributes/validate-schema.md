...
1. 在[!UICONTROL File Upload and Schema Validation]页面上，单击&#x200B;**[!UICONTROL Actions]** > **[!UICONTROL View/Edit Schema]**
...
* **[!UICONTROL Add Data:]**&#x200B;将新属性数据上载到此数据源。

* **[!UICONTROL View/Edit Schema:]**&#x200B;将显示名称映射到属性数据，如下一步骤中所述。

* **[!UICONTROL FTP Setup:]**&#x200B;创建您的FTP帐户以[通过FTP上传您的数据](t-upload-attributes-ftp.md)（可选）。

* **[!UICONTROL ID Lookup:]**&#x200B;输入您`.csv`中的客户ID (CID)以查找该ID的Experience Cloud信息。 此功能可用于解决为何属性数据不对访客显示的问题：

   * **[!UICONTROL ECID (Experience Cloud ID):]**&#x200B;在您使用最新的Experience Cloud ID服务时显示。 如果您在使用MCID服务，但此处未列出ID，则Experience Cloud尚未收到该CID的别名。 这意味着访客还没有登录，或您的实施没有传递此 ID。
