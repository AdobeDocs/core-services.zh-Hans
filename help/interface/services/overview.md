...
# Experience Cloud界面概述

Experience Cloud的接口功能有时称为&#x200B;_核心服务_。 它们是统一的标头功能，包括[!DNL People]服务（[!DNL Audience Library]和[!DNL Customer Attributes]）。

其他共享功能包括Experience Cloud、Cookie、帐户首选项、通知等的管理（用户和产品管理）。

要在Experience Cloud中访问共享服务和应用程序，请单击&#x200B;**[!UICONTROL Application Selector]**
...
| [触发器](https://experienceleague.adobe.com/zh-hans/docs/core-services/interface/services/triggers) | Experience Cloud中的触发器允许您识别、定义并监视关键客户行为，然后生成跨应用程序通信以便重新吸引访客。 您可以在实时决策和个性化中使用触发器。 |
