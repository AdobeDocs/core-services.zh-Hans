...
>[!NOTE]
>
>有关完整的CX Enterprise ID服务帮助（以前称为访客ID），请参阅[CX Enterprise Identity Service概述](https://experienceleague.adobe.com/docs/id-service/using/intro/overview.html?lang=zh-Hans#intro)。
...
| 任务 | 描述 |
| --- | --- |
| [为Analytics实施CX Enterprise ID服务](https://experienceleague.adobe.com/zh-hans/docs/analytics/implementation/id/overview) | Adobe 还建议设置其他[客户 ID](https://experienceleague.adobe.com/zh-hans/docs/id-service/using/reference/authenticated-state)。 这些ID与每个访客相关联，并可以启用CX Enterprise中现有和未来的功能。 |
...
有关详细信息，请参阅[客户属性](https://experienceleague.adobe.com/zh-hans/docs/core-services/interface/services/customer-attributes/attributes)。

### [!UICONTROL People] > [!UICONTROL Audience Library]

CX Enterprise [!UICONTROL Audiences]是一个界面，您可以从这里创建受众，合并现有受众以创建复合受众，以及查看所有共享受众。

有关详细信息，请参阅[受众](https://experienceleague.adobe.com/zh-hans/docs/core-services/interface/services/audiences/overview)。
