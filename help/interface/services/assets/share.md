...
1. 在Asset文件夹中，单击&#x200B;**[!UICONTROL 共享到Creative Cloud]**。

   ![共享到 Creative Cloud](../../assets/asset-share-cc.png)
1. 在“共享到Creative Cloud”页面上，搜索该用户，然后单击&#x200B;**[!UICONTROL 添加]**。
...
1. 在共享资源中添加评论以继续：
   ...
   在Creative Cloud中，您可以选择进入图像，然后单击&#x200B;**[!UICONTROL 活动]**&#x200B;以在图像上添加评论。 评论会在 [!DNL Creative Cloud] 和 [!DNL CX Enterprise] 的资源中同步。
