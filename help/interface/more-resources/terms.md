...
| **访客ID服务/ECID** | 跨解决方案使用的永久性访客标识符；通常与标记或Web SDK一起部署。 在旧版Analytics讨论中通常引用为&#x200B;**MID**。 查看[访客ID服务概述](https://experienceleague.adobe.com/docs/id-service/using/home.html)。 | 不同于单个应用程序的旧版Cookie名称或&#x200B;**Experience Platform Identity Service**&#x200B;概念，但它们可以在实现中关联。 |
