...
| 日期 | 更新 | 描述 |
| ------- | ------- | ------- |
| 2026年7月10日 | CX Enterprise对联合来宾访问的支持 | 如果已启用[联合来宾访问](https://helpx.adobe.com/business/enterprise/using/federated-guest-access.html)在您自己的域上安全地验证来宾用户，则CX Enterprise允许这些用户在帐户之间切换。 可从任何[CX Enterprise](https://experience.adobe.com)页面上的“组织”切换器切换帐户。 |
